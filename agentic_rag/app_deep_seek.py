...
def load_llm():
    """
    Load a lightweight LLM from Ollama.
    Using gemma:2b (low RAM friendly).
    """
    llm = LLM(
        model="ollama/gemma:2b",     # ✅ Changed from deepseek-r1:7b
...
# ===========================
st.markdown("""
    # Agentic RAG powered by Ollama Gemma 2B
